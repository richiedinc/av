		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group mt-3">
					...
					<input id="video_share_url" type="text" class="form-control" value="{$baseurl}/video/{$video.VID}/{$video.title|clean}" readonly>
				...
				<div class="col-12">
					...
					<div class="mt-3 overflow-hidden">
						...
						{section name=i loop=$keywords}
							<a class="tag" href="{$relative}/search/videos/{$keywords[i]}">{$keywords[i]}</a>{if !$smarty.section.i.last},{/if}
						{/section}						
					</div>					
				</div>
			</div>
